...
Requires: python3-cachecontrol >= 0.13.0
Requires: python3-cleo >= 2.0.0
Requires: python3-crashtest >= 0.4.1
Requires: python3-dulwich >= 0.21.2
Requires: python3-importlib-metadata >= 4.4
Requires: python3-installer >= 0.7.0
...
Requires: python3-pkginfo >= 1.9.4
Requires: python3-platformdirs >= 3.0.0
Requires: python3-poetry-core >= 1.7.0
Requires: python3-poetry-plugin-export >= 1.5.0
...
Requires: python3-tomlkit >= 0.11.4
Requires: python3-trove-classifiers >= 2022.5.19
Requires: python3-virtualenv >= 20.22.0
